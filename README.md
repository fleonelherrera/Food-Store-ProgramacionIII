...
Aplicación frontend de una tienda de comidas desarrollada con HTML, CSS y TypeScript.

### Funcionalidades

- Catálogo de productos con búsqueda por nombre y filtrado por categoría.
- Carrito de compras con persistencia en localStorage.
- Visualización de productos agregados, cantidades y total de la compra.
